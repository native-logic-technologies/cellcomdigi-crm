...
const reducersSchema = __reducers(
  ...
  __reducerSchema("archive_messages", ArchiveMessagesReducer),
  ...
  __reducerSchema("deduplicate_companies", DeduplicateCompaniesReducer),
  __reducerSchema("deduplicate_contacts", DeduplicateContactsReducer),
  __reducerSchema("deduplicate_deals", DeduplicateDealsReducer),
  __reducerSchema("deduplicate_documents", DeduplicateDocumentsReducer),
  __reducerSchema("deduplicate_memories", DeduplicateMemoriesReducer),
  __reducerSchema("deduplicate_products", DeduplicateProductsReducer),
  __reducerSchema("deduplicate_social_campaigns", DeduplicateSocialCampaignsReducer),
  __reducerSchema("deduplicate_social_posts", DeduplicateSocialPostsReducer),
  __reducerSchema("deep_clean", DeepCleanReducer),
  ...
  __reducerSchema("delete_messages_batch", DeleteMessagesBatchReducer),
  ...
  __reducerSchema("prune_duplicate_kg_edges", PruneDuplicateKgEdgesReducer),
  __reducerSchema("prune_old_activities", PruneOldActivitiesReducer),
  __reducerSchema("prune_old_memories", PruneOldMemoriesReducer),
  __reducerSchema("prune_orphaned_activities", PruneOrphanedActivitiesReducer),
  __reducerSchema("prune_orphaned_containers", PruneOrphanedContainersReducer),
  __reducerSchema("prune_orphaned_conversations", PruneOrphanedConversationsReducer),
  __reducerSchema("prune_orphaned_deal_stage_history", PruneOrphanedDealStageHistoryReducer),
  __reducerSchema("prune_orphaned_invoice_items", PruneOrphanedInvoiceItemsReducer),
  __reducerSchema("prune_orphaned_kg_vertices", PruneOrphanedKgVerticesReducer),
  __reducerSchema("prune_orphaned_payments", PruneOrphanedPaymentsReducer),
  __reducerSchema("prune_orphaned_workflow_executions", PruneOrphanedWorkflowExecutionsReducer),
  __reducerSchema("prune_pipelines", PrunePipelinesReducer),
  __reducerSchema("publish_social_post", PublishSocialPostReducer),
  __reducerSchema("rebuild_knowledge_graph", RebuildKnowledgeGraphReducer),
  ...
  __reducerSchema("seed_inbox_data", SeedInboxDataReducer),
