...
import {
  ...
  ExternalLink, Tag, Database, TrendingUp, Link2
} from 'lucide-react';
  ...
  return (
    <div className="space-y-5 max-w-7xl mx-auto animate-fade-in">
      <PageHeader
        ...
        subtitle="Central hub for documents, memories, and intelligence containers"
      />
                    ...
                    <Card key={d.id.toString()} className="border border-slate-100 shadow-sm">
                      <CardBody className="p-4">
                        <div className="flex items-start justify-between">
                          ...
                          {d.sourceUrl && (
                            <a href={d.sourceUrl} target="_blank" rel="noreferrer" className="p-1.5 rounded hover:bg-slate-100 text-slate-400">
                ...
                <CardBody className="p-4 space-y-4">
                  ...
                  {extractingInsights && (
                    <div className="flex items-center gap-2 text-xs text-amber-600">
                      ...
                      Extracting insights with Mercury 2...
                    </div>
                  )}
                </CardBody>
              </Card>
