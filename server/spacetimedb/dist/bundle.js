...
function requireTenant(ctx, tenantId) {
	...
	if (!member || member.tenant_id !== tenantId) throw new Error("Unauthorized: identity is not a member of this tenant");
}
...
const createVertex = spacetimedb.reducer({
	tenant_id: t.u64(),
	entity_type: entityType,
...
const updateVertex = spacetimedb.reducer({
	id: t.u64(),
	properties: t.string(),
	vector_embedding: t.option(t.array(t.f32()))
...
const deleteVertex = spacetimedb.reducer({ id: t.u64() }, (ctx, { id }) => {
	const vertex = ctx.db.kg_vertex.id.find(id);
	if (!vertex) throw new Error("Vertex not found");
	requireTenant(ctx, vertex.tenant_id);
	const toDelete = [];
	for (const edge of ctx.db.kg_edge.iter()) if (edge.source_vertex_id === id || edge.target_vertex_id === id) toDelete.push(edge.id);
	for (const edgeId of toDelete) ctx.db.kg_edge.id.delete(edgeId);
	ctx.db.kg_vertex.id.delete(id);
});
const createEdge = spacetimedb.reducer({
	tenant_id: t.u64(),
	...
	if (src.tenant_id !== tenant_id || tgt.tenant_id !== tenant_id) throw new Error("Vertices do not belong to the specified tenant");
...
const updateEdge = spacetimedb.reducer({
	id: t.u64(),
	properties: t.string(),
	weight: t.option(t.f32())
...
const deleteEdge = spacetimedb.reducer({ id: t.u64() }, (ctx, { id }) => {
	const edge = ctx.db.kg_edge.id.find(id);
	if (!edge) throw new Error("Edge not found");
	requireTenant(ctx, edge.tenant_id);
	ctx.db.kg_edge.id.delete(id);
});
const mergeVertices = spacetimedb.reducer({
	source_id: t.u64(),
	target_id: t.u64()
}, (ctx, { source_id, target_id }) => {
	if (source_id === target_id) throw new Error("Cannot merge a vertex into itself");
	...
	if (source.tenant_id !== target.tenant_id) throw new Error("Vertices belong to different tenants");
	const edgesToRewire = [];
	for (const edge of ctx.db.kg_edge.iter()) if (edge.source_vertex_id === source_id || edge.target_vertex_id === source_id) edgesToRewire.push(edge);
	for (const edge of edgesToRewire) {
		...
		if (newSource === newTarget) ctx.db.kg_edge.id.delete(edge.id);
		else ctx.db.kg_edge.id.update({
			...edge,
...
const findNeighbors = spacetimedb.reducer({
	vertex_id: t.u64(),
	...
	for (const edge of ctx.db.kg_edge.iter()) {
		if (!(edge.tenant_id === vertex.tenant_id && (edge.source_vertex_id === vertex_id || edge.target_vertex_id === vertex_id))) continue;
		if (relation_type !== void 0 && edge.relation_type !== relation_type) continue;
		neighbors.push(edge.source_vertex_id === vertex_id ? edge.target_vertex_id : edge.source_vertex_id);
	}
	console.info(`Neighbors of vertex ${vertex_id} (relation ${relation_type}): ${JSON.stringify(neighbors)}`);
});
const bfsTraverse = spacetimedb.reducer({
	...
	console.info(`BFS from ${start_vertex_id} (depth ${max_depth}): ${JSON.stringify(results)}`);
});
...
//#endregion
export { addTenantMember, bfsTraverse, createEdge, createVertex, spacetimedb as default, deleteEdge, deleteVertex, findNeighbors, init, mergeVertices, onConnect, onDisconnect, updateEdge, updateVertex };
//# debugId=442e283e-ed7b-4465-8ede-6f04d2a22290
//# sourceMappingURL=data:application/json;charset=utf-8;base64,