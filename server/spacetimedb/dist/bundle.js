...
const createCompany = spacetimedb.reducer({
	...
	billing_address: t.string(),
	notes: t.string()
}, (ctx, { tenant_id, name, registration_number, industry, phone, email, website, address, billing_address, notes }) => {
	requireTenant(ctx, tenant_id);
...
const updateCompany = spacetimedb.reducer({
	...
	billing_address: t.string(),
	notes: t.string()
}, (ctx, { id, name, registration_number, industry, phone, email, website, address, billing_address, notes }) => {
...
const seedDemoData = spacetimedb.reducer({}, (ctx) => {
	...
	const companies = [
		{
			...
			industry: "Technology",
			phone: "+603-2288-1000",
			email: "hello@techventure.my",
			website: "https://techventure.my",
			address: "{\"street\":\"Level 12, Menara Global\",\"city\":\"Kuala Lumpur\",\"postcode\":\"50450\",\"state\":\"Wilayah Persekutuan\"}",
			notes: "Long-term client. Interested in enterprise package."
		},
		{
			...
			website: "https://greenleaf.my",
			address: "{\"street\":\"No 45, Jalan SS15/4\",\"city\":\"Subang Jaya\",\"postcode\":\"47500\",\"state\":\"Selangor\"}",
			notes: "Catering for corporate events. Seasonal demand spikes."
		},
		{
			...
			industry: "Logistics",
			phone: "+603-5566-8800",
			email: "biz@metrolog.my",
			website: "https://metrolog.my",
			address: "{\"street\":\"Lot 12, Jalan Kemajuan\",\"city\":\"Shah Alam\",\"postcode\":\"40150\",\"state\":\"Selangor\"}",
			notes: "Wants integration with their WMS."
		},
		{
			name: "Durian Digital Marketing",
			reg: "202110054321",
			industry: "Marketing",
			phone: "+6019-876-5432",
			email: "hello@durian.digital",
			website: "https://durian.digital",
			address: "{\"street\":\"Co-labs, One Utama\",\"city\":\"Petaling Jaya\",\"postcode\":\"47800\",\"state\":\"Selangor\"}",
			notes: "Referral from TechVenture. High growth startup."
		},
		{
			name: "Palm Oil Plantation Berhad",
			reg: "199805002211",
			industry: "Agriculture",
			phone: "+609-555-1212",
			email: "procurement@popb.my",
			website: "https://popb.my",
			address: "{\"street\":\"KM45, Jalan Kuantan\",\"city\":\"Kuantan\",\"postcode\":\"25200\",\"state\":\"Pahang\"}",
	...
	for (const d of [
		...
		{
			name: "Durian Digital Onboarding",
			contactIdx: 5,
			companyIdx: 3,
			stageIdx: 2,
			value: 680000n
	...
	for (const inv of [
		...
		const issue = /* @__PURE__ */ new Date(now.toDate().getTime() - 30 * 864e5);
		const due = new Date(issue.getTime() + 14 * 864e5);
		ctx.db.invoices.insert({
			...
			subtotal: BigInt(Math.round(Number(inv.total) * .9)),
			tax_amount: BigInt(Math.round(Number(inv.total) * .1)),
			total: inv.total,
			currency: "MYR",
	...
	for (const a of [
		...
		},
		{
			contactIdx: 3,
			type: "Call",
			desc: "Demo walkthrough for Mei Ling"
		},
		{
			contactIdx: 5,
			type: "Meeting",
			desc: "Kickoff with Durian Digital team"
		},
		{
			contactIdx: 6,
			type: "Email",
			desc: "Sent enterprise quote to Nurul"
		},
		{
			contactIdx: 7,
			type: "Whatsapp",
			desc: "Confirmed add-on license count"
		}
	]) ctx.db.activities.insert({
		id: 0n,
		tenant_id: TENANT_ID,
	...
	for (const m of [
		{
			convIdx: 0,
			body: "Hi, can we schedule a demo this week?",
			dir: "Inbound"
		},
		{
			convIdx: 0,
			body: "Sure, how about Thursday 2pm?",
			dir: "Outbound"
		},
		{
			convIdx: 1,
			body: "Thanks for the quote, we need to discuss internally.",
			dir: "Inbound"
		},
		{
			convIdx: 2,
			body: "Invoice INV-2024-001 has been paid. Thank you!",
			dir: "Outbound"
		}
